...
# Load credentials from Streamlit Secrets (use directly as a dictionary)
...
# Open Google Sheet
sheet = client.open("BATPATH_Player_Data").sheet1  # Change to your actual Google Sheet name
